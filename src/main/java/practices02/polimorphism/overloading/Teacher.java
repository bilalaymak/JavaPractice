package practices02.polimorphism.overloading;
...
public class Teacher {
    ...
    /*
      ...
      Method overloading in programming allows you to define multiple methods with the same name
      but with different parameters in the same class.
      The idea behind this is to allow you to write methods
      that perform similar actions but with a different number or type of arguments.

      note: the return type of overloaded method does not have to be void.
